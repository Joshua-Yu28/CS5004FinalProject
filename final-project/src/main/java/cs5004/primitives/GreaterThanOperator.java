 ...
 * which checks if the first integer argument is greater than the second integer argument.
 */
public class GreaterThanOperator extends AbstractPrimitive {

  /**
   * Applies the greater than operation on the provided arguments.
   *
  ...
  public Value apply(List<Value> args) {
    ...
    if (args == null || args.size() != 2) {
      throw new ArityMismatchException("Greater", 2, args.size());
    }
    ...
    // Perform the greater than comparison and return the result
